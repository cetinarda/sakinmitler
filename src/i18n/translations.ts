...
export const TR = {
  ...
  'profile.hd.profile': 'Human Design · Profil {profile} · {n}/9 merkez tanımlı',
  'profile.hd.precision.high': 'Yüksek',
  'profile.hd.precision.medium': 'Orta',
  'profile.hd.precision.low': 'Düşük',
  'profile.hd.strategyLabel': 'Strateji',
  'profile.hd.authorityLabel': 'Otorite',
  'profile.hd.signatureLabel': 'İmza',
  'profile.hd.notSelfLabel': 'Not-Self (yanlış yöndesin sinyali)',
  'profile.hd.centersHeader': '9 Enerji Merkezi',
  'profile.hd.statusDefined': 'TANIMLI',
  'profile.hd.statusOpen': 'AÇIK',
...
export const EN: Record<keyof typeof TR, string> = {
  ...
  'profile.hd.profile': 'Human Design · Profile {profile} · {n}/9 centers defined',
  'profile.hd.precision.high': 'High',
  'profile.hd.precision.medium': 'Medium',
  'profile.hd.precision.low': 'Low',
  'profile.hd.strategyLabel': 'Strategy',
  'profile.hd.authorityLabel': 'Authority',
  'profile.hd.signatureLabel': 'Signature',
  'profile.hd.notSelfLabel': 'Not-Self (signal you\'re going the wrong way)',
  'profile.hd.centersHeader': '9 Energy Centers',
  'profile.hd.statusDefined': 'DEFINED',
  'profile.hd.statusOpen': 'OPEN',
